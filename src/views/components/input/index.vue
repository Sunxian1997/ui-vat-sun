...
<template>
  <div>
    ...
    <div>
      ...
      <vat-table :data="data" :header="header" border>
      </vat-table>
    </div>
...
<script>
   export default {
      components:{
         'foldable-card':()=>import('../../../components/foldableCard.vue'),
         'vat-table':()=>import('../../../components/table.vue'),
         'vat-input':()=>import('@/components/input')
      },
      data(){
         return {
            input:'',
